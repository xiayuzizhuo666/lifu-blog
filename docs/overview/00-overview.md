...
lifu-blog 是一个基于 **Astro 5.x** 构建的现代化静态博客系统，从 Hexo 迁移而来，灵感源自 Shoka 主题。项目采用 React 实现交互组件，Tailwind CSS 进行样式设计，同时保持与原有 Hexo 博客内容的兼容性。
...
- lifu-blog 是一个从 Hexo 迁移到 Astro 的现代化博客项目
