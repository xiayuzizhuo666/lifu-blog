  ...
  return (
    <div className="mb-4 w-full">
      <div className="relative overflow-hidden rounded-3xl border-2 border-gray-100 bg-white p-6 shadow-sm md:p-3 dark:border-gray-800 dark:bg-gray-900">
        {/* Cute Corner Decor */}
        <div className="absolute -top-6 -right-6 h-24 w-24 rounded-full bg-muted/30" />
        ...
        <div className="grid grid-cols-2 gap-12 md:grid-cols-1 md:gap-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="group relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border-2 border-gray-100 bg-gray-50/50 px-4 py-2.5 font-bold text-gray-700 text-sm transition-all focus:border-primary/30 focus:ring-primary/10 dark:focus:border-primary/50 dark:focus:ring-primary/20"
                ...
                <div className="group relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full rounded-xl border-2 border-gray-100 bg-gray-50/50 px-4 py-2.5 font-bold text-gray-700 text-sm transition-all focus:border-primary/30 focus:bg-white focus:outline-none focus:ring-4 focus:ring-primary/10 dark:border-gray-700 dark:bg-gray-800/50 dark:text-gray-200 dark:focus:border-primary/50 dark:focus:bg-gray-800 dark:focus:ring-primary/20"
          ...
          <div className="relative flex flex-col justify-center rounded-xl bg-gray-50 p-6 md:p-3 dark:bg-gray-800/50">
            ...
            <div className="mt-6 flex items-center gap-3 rounded-xl bg-muted p-4 font-medium text-muted-foreground text-xs">
              {t('friends.hint')}
            </div>
          </div>
        </div>
